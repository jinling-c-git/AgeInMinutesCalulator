package project.u.ageinminitescalculator
...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickDatePicker(){
        ...
        val dpd = DatePickerDialog(this, DatePickerDialog.OnDateSetListener{view, selectedYear, selectedMonth, selectedDayOfMonth ->
            ...
            theDate?.let{
                ...
                currentDate?.let{
                    ...
                    val differenceInMinutes = currentDateInMinutes - selectedDateInMiNUTES // it's a long data type
        ...
        dpd.datePicker.maxDate = System.currentTimeMillis() - 86400000  //to restrict cannot select the future date
        dpd.show()
